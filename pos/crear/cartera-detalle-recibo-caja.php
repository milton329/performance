...
?>
		    ...
		    <div class="panel">
		          ...
		          <div class="box-row valign-middle">
		            ...
		            <div class="box-cell col-md-8">
		              ...
		              <div class="display-inline-block m-r-3 valign-middle">
		                <div class="text-muted"><strong>Recibo de caja</strong></div>
		              ...
		              <div class="display-inline-block p-l-1 b-l-3 valign-middle font-size-12 text-muted">
		              	<div>Chocolates y Vitaminas</div>
		      ...
		      <div class="panel-body p-a-4" id="rsp-div-opc-asdf">
		      	<?php include '../cartera/estructura/estructura-tab-cartera-rc.php';;?>
		      </div>


		      <?php if($documento["cerrado"] == 0){?>

		      <a href="#load_modulo" class="pull-right btn btn-warning" onClick="Funciones.cargar_modal_estructura('0_<?= $id;?>', 'add_factura_a_rc', 'load_modulo', 2);" title="Agregar producto" data-toggle="modal"  style="margin-right: 10px;">
