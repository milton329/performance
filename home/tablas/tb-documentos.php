...
$ventas="select m.fecha_registro as 'fecha_registro',m.documento,m.cliente_identificacion,m.cliente_nombre, sum(r.sub_total) as 'total',   sum(r.salida) as 't_cantidad' 
     FROM mov m LEFT JOIN mov_r r ON m.documento = r.documento where m.tipo_documento='REM' and m.periodo='".date("m")."' 
