...
session_start();
	...
	if($_POST['nombre'] != "" && $_POST['tipo_reporte'] != "" && $_POST['instancia'] != "" && $_POST['bd'] != "" && $_POST['usuario'] != ""
	 && $_POST['clave'] != "" && $_POST['sql_'] != ""){
		...
		//echo $_POST['instancia']; // = $oGlobals->back_slash($_POST['instancia']);
		//return;
		...
		if($id == "") 	{ 
			...
			$insert = $oGlobals->insert_data_array($_POST, "informes"); 
		}
		else $update = $oGlobals->update_data_array($_POST, "informes", "id", $id);
