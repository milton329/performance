...
session_start();
	...
	if(trim($_POST["id_autoevaluaciones"])){	
		...
		$sql4 		= "select count(a.valor_usuario) as total from auto_evaluaciones
					   INNER JOIN auto_evaluaciones_r as a ON a.id_autoevaluaciones = auto_evaluaciones.id
					   where auto_evaluaciones.documento='".$documento."' and a.valor_usuario>'0.0' ";			
