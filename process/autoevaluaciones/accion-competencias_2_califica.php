...
session_start();
	...
	if(trim($_POST["id_autoevaluaciones"])){	
        ...
        $_POST["valor_usuario_califica"]    		= $valor;
		...
		$sql4 		= "select count(a.valor_usuario_califica) as total from auto_evaluaciones
					   INNER JOIN auto_evaluaciones_r as a ON a.id_autoevaluaciones = auto_evaluaciones.id
					   where auto_evaluaciones.documento='".$documento."' and a.valor_usuario_califica>'0.0' ";			
