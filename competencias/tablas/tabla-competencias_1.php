    ...
    <table class="table  table-bordered table-hover" >
        ...
        <tbody id="tb_body">
            ...
            <?php $num=$num+1;} ?>
                        ...
                        <div class="text-left" style="background: none !important;">
                            <br>
                            <button class="btn btn-danger" type="submit">Guardar valores ponderados <span class="btn-label-icon left fa fa-save"></span></button>
                        </form>
</div>
