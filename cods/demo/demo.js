(function(root, factory) {
  ...
  var pxDemo = (function() {
    ...
    var BACKGROUNDS = [
      DIST_PATH + '/cods/demo/bgs/1.jpg',
      DIST_PATH + '/cods/demo/bgs/2.jpg',
      DIST_PATH + '/cods/demo/bgs/3.jpg',
      DIST_PATH + '/cods/demo/bgs/4.jpg',
      DIST_PATH + '/cods/demo/bgs/5.jpg',
      DIST_PATH + '/cods/demo/bgs/6.jpg',
      DIST_PATH + '/cods/demo/bgs/7.jpg',
      DIST_PATH + '/cods/demo/bgs/8.jpg',
      DIST_PATH + '/cods/demo/bgs/9.jpg',
    ];
    ...
    function setTheme(themeName) {
      ...
      var themePath = DIST_PATH + '/cods/css/themes/' + themeName + (_isRtl ? '.rtl' : '') + '.min.css';
    ...
    function initializeDemoSidebar() {
      ...
      for (var i = 0, l = THEMES.length; i < l; i++) {
        content += '<label class="px-demo-themes-item">';
          ...
          content += '<img src="' + DIST_PATH + '/cods/demo/themes/' + THEMES[i] + '.png" class="px-demo-themes-thumbnail">';
