<?php 
	...
	if(isset($id) && is_numeric($id)){
		...
		$documento = $oGlobals->verOpcionesPor("mov_cartera", " AND id = $id  AND tipo_documento = 'CG'".$con_emp, 0);
...
?>
			...
			<div class="page-header">
		        <div class="col-md-12 text-xs-center text-md-left">
		          <h1>
		          	<span class="text-muted font-weight-light"><i class="page-header-icon ion-arrow-graph-up-right"></i> Financiero/ Causación de gastos / </span>
		    ...
		    <?php if($documento["cerrado"] == 0){?>
				    <a class="pull-right btn btn-danger" onClick="Funciones.cerrar_documento_nuevo('finalizar_rc', '1', '<?= $documento["id"];?>', 'rsp-fin');" title="Finalizar factura" >
		    ...
		    <div class="panel">
		          ...
		          <div class="box-row valign-middle">
		            ...
		            <div class="box-cell col-md-8">
		              ...
		              <div class="display-inline-block m-r-3 valign-middle">
		                <div class="text-muted"><strong>Causación de Gastos</strong></div>
		      ...
		      <a href="#load_modulo" class="pull-right btn btn-danger" onClick="Funciones.cargar_modal_estructura('0_<?= $id;?>', 'add_registro_cg', 'load_modulo', 2);" title="Agregar producto" data-toggle="modal"  style="margin-right: 10px;">
