    ...
    <div class="modal-dialog page-profile">
      ...
      <div class="modal-content" >
        ...
        <div class="modal-header bg-primary darker" style="text-align:center;">
          ...
          <h3 style="color:#FFFFFF">Agregar un producto al documento: <?= $documento["documento"];?></strong></h3>
        </div>
        ...
        <div class="modal-body paddin">	
            ...
            <form id="frm-producto-ref" name="frm-producto-ref" class="form_sdv form-horizontal" method="post" action="../process/pedido/accion-documento-pedidos-detalle.php">
