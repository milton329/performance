  ...
  <div class="table-responsive">
    <table class="table m-a-0 table-striped ">
      ...
      <tbody id="tr_body_ref_com" class="font-size-14">
        ...
        <?php 
            $productos = $oGlobals->verOpcionesPor("mov_r_pedidos", "AND documento = '".$documento["documento"]."'", 1);
            if($productos != 2){
              ...
              foreach ($productos as $producto) {
                ...
                $t_subtotal += $producto["sub_pedido"];
                $t_cantidad += $producto["cantidad_pedida"];
        ?>
                <tr id="tradfasasdf_<?= $producto["id"];?>">
                  ...
                  <td class="p-a-1" align="right"><?= number_format($producto["cantidad_pedida"], 0, "", ".");?></td>
                  <td class="p-a-1" align="right"><?= number_format($producto["valor_unitario"], 0, "", ".");?></td>
                  <td class="p-a-1" align="right"><?= number_format($producto["sub_pedido"], 0, "", ".");?></td>
