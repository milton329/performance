      ...
      <tbody id="tr_body_ref_fac" class="font-size-14">
        ...
        ?>
                <tr id="trttrr_<?= $producto["id"];?>">
                  ...
                  <td class="p-a-1" align="center"><?= utf8_encode($producto["referencia"]);?></td>
                  ...
                  <?php if($documento["cerrado"] == 0){?>
                        <td align="center" width="8%">
                          <a href="#load_modulo" onClick="Funciones.cargar_modal_estructura('<?= $producto["id"]."_".$id;?>', 'add_producto_a_factura', 'load_modulo', 2);" data-toggle="modal"><i class="btn btn-xs fa fa-edit"></i></a>
        ...
        ?>
          ...
          <tbody class="font-size-14" style="border-top: 0px !important;">
            ...
            <tr>
                <td class="p-a-1" colspan="5" align="right"><strong>Totales:</strong></td>
                <td class="p-a-1" align="right"><strong><?= number_format($t_subtotal, 0, "", ".");?></strong></td>
                <?php if($documento["cerrado"] == 0){?><td></td><?php }?>
            </tr>
