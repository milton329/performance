...
?>
		    ...
		    <?php if($documento["cerrado"] == 0){?>
				    <a class="pull-right btn btn-success" onClick="Funciones.cerrar_documento('finalizar-compra', '1', '<?= $documento["id"];?>', 'rsp-fin');" title="Editar usuario" >
		    ...
		    <div class="panel">
		          ...
		          <div class="box-row valign-middle">
		            ...
		            <div class="box-cell col-md-8">
		              <div class="display-inline-block px-demo-brand px-demo-brand-lg valign-middle">
		                <span class="px-demo-logo m-y-0 m-r-2 bg-success"><span class="px-demo-logo-1"></span><span class="px-demo-logo-2"></span><span class="px-demo-logo-3"></span><span class="px-demo-logo-4"></span><span class="px-demo-logo-5"></span><span class="px-demo-logo-6"></span><span class="px-demo-logo-7"></span><span class="px-demo-logo-8"></span><span class="px-demo-logo-9"></span></span>
		              </div>
		              ...
		              <div class="display-inline-block p-l-1 b-l-3 valign-middle font-size-12 text-muted">
		                ...
		                <div>Moneda <?= utf8_encode($moneda["moneda"]);?>, TRM <?= utf8_encode($documento["trm"]);?></div>
		              </div>
		      ...
		      <div class="panel-body table-success" id="rsp-div-opc-asdf">

		      	<?php 

		      		include $arbol.'../documentos/estructura/estructura-tab-documento-compra.php';
		      	?>
		      </div>
		      ...
		      <a href="#load_modulo" class="pull-right btn btn-success" onClick="Funciones.cargar_modal_estructura('0_<?= $id;?>', 'add_producto_a_compra', 'load_modulo', 2);" title="Agregar producto" data-toggle="modal"  style="margin-right: 10px;">
