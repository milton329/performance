		    ...
		    <div class="panel">
		          ...
		          <div class="box-row valign-middle">
		            ...
		            <div class="box-cell col-md-8">
		              ...
		              <div class="display-inline-block m-r-3 valign-middle">
		                <div class="text-muted"><strong>Cotizacion</strong></div>
		      ...
		      <div class="panel-body table-primary" id="rsp-div-opc-asdf">
		      	...
		      	<?php 
		      		...
		      		include $arbol.'../documentos/estructura/estructura-tab-documento-cotizacion.php';
		      	?>
		      </div>
		      ...
		      <a href="#load_modulo" class="pull-right btn btn-primary" onClick="Funciones.cargar_modal_estructura('0_<?= $id;?>', 'add_producto_a_cotizacion', 'load_modulo', 2);" title="Agregar producto" data-toggle="modal"  style="margin-right: 10px;">
