    ...
    <div class="panel">
      <div class="panel-body">
        	<div class="table-danger">
					...
					<form action="../process/documento/accion-documento-cotizacion.php" id="frm-cotizacion" name="frm-compra" method="post"  class="form_sdv form-horizontal" enctype="multipart/form-data"> 
   						
   						<input type="hidden" id="id" name="id">
   						<input type="hidden" id="id_tipo_documento" name="id_tipo_documento" value="17" />
						...
						<div class="panel-footer text-right">
							<button class="btn btn-primary darker" type="button" onClick="location.href='../documentos/menu_consultar-cotizacion.html'">Volver</button>
