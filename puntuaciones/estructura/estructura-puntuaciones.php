      ...
      <div class="modal-content" >
        ...
        <div class="modal-body paddin" style=" background: #f6f6f6;">	
               ...
               <div id="div-modulo-opcion">
               		...
               		<form action="../process/puntuaciones/accion-puntuaciones.php" id="frm-crear-puntuaciones" name="frm-crear-puntuaciones" method="post"  class="form_sdv form-horizontal"> 
						...
						<div class="row">                                                            
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control form-group-margin" type="number" id="valor" name="valor"/>
                                    </div>
                                    <div class="col-md-12">
						...
						<div id="rsp-frm-crear-puntuaciones"></div>
						<div class="panel-footer text-right" style="background: none !important;">
							<button class="btn btn-danger" type="button" onClick="location.href='../puntuaciones'">Volver</button>
